...
const STUDIO_25: HydratedProduct = {
  ...
  useCases: [
    ...
    { id: 'uc-studio-q1', productId: 'cp-studio-25', text: 'Virtual Goalf',               context: 'card',       displayOrder: 4 },
    { id: 'uc-studio-q1', productId: 'cp-studio-25', text: 'Office + Meeting Room',       context: 'quick-view', displayOrder: 5 },
    { id: 'uc-studio-q2', productId: 'cp-studio-25', text: 'Golf Practice Room',          context: 'quick-view', displayOrder: 6 },
    { id: 'uc-studio-q3', productId: 'cp-studio-25', text: 'Sauna Getaway',               context: 'quick-view', displayOrder: 7 },
    { id: 'uc-studio-q4', productId: 'cp-studio-25', text: 'Design Studio',               context: 'quick-view', displayOrder: 8 },
    { id: 'uc-studio-q5', productId: 'cp-studio-25', text: 'Home Cinema',                 context: 'quick-view', displayOrder: 9 },
  ],
  ...
  layoutOptions: [
    ...
    },
    {
      ...
      priceDeltaCentsInclVat: 1_320_000,
    ...
    },
    {
      ...
      priceDeltaCentsInclVat: 1_540_000,
      includesBathroom: true,
      includesKitchen: true,
  ...
  floorPlanVariants: [
    {
      ...
      floorPlan: {
        apertures: [
          ...
          { type: 'french-door',     wall: 'south', widthMm: 1600, heightMm: 2100 },
        ],
        dimensionLabels: { width: '5.0m', depth: '5.0m' },
      },
...
const LIVING_35: HydratedProduct = {
  ...
  floorPlan: {
    apertures: [
      { type: 'tilt-turn-window', wall: 'north', widthMm: 700,  heightMm: 2100 },
      { type: 'tilt-turn-window', wall: 'north', widthMm: 700,  heightMm: 2100 },
      { type: 'french-door',     wall: 'east',  widthMm: 2400, heightMm: 2100 },
    ],
...
const GRAND_45: HydratedProduct = {
  ...
  specs: [
    ...
    { id: 'sp-grand-06', productId: 'cp-grand-45', label: 'Glazing',     value: '2\u00D7 tilt & turn windows + French door + French door', displayOrder: 6 },
  ...
  floorPlan: {
    apertures: [
      ...
      { type: 'tilt-turn-window', wall: 'north', widthMm: 900,  heightMm: 2100 },
      { type: 'french-door',      wall: 'east',  widthMm: 1600, heightMm: 2100 },
      { type: 'french-door',     wall: 'south', widthMm: 3000, heightMm: 2100 },
    ],
