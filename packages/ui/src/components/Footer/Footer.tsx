...
/**
 * Interface for the Social Link data structure.
 * Represents a single social media platform connection.
 */
...
/**
 * Interface for Navigation Link data structure.
 * Represents internal or external site links.
 */
interface NavLink {
  id: string;
  label: string;
...
/**
 * Static data definition for Social Media links.
 * Contains SVG paths for Facebook, Behance, Instagram, and Dribbble.
 */
...
/**
 * Footer Component
 * * A responsive footer layout implementing a 4-column grid design.
 * Features:
 * - Brand description
 * - Contact information
 * - Navigation links
      ...
      <div className="footer__container">
        ...
        <div className="footer__column footer__column--brand">
          ...
          <p className="footer__description">
            Modular House is a premier specialist in steel frame construction, dedicated to transforming homes with precision and speed. We deliver bespoke, energy-efficient garden rooms and house extensions designed for modern living and built to last a lifetime.
          </p>
        </div>
            ...
            {NAV_LINKS.map((link) => (
              <li key={link.id} className="footer__nav-item">
                {/* 
                  ...
                  to prevent full page reloads and maintain application state.
                */}
