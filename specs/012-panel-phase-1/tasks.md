...
- [ ] T007 Extend the seed with displayName + Phase 1 permissions
...
- [ ] T008 Remove the legacy frontend admin UI and localStorage token flow
...
- [ ] T009 Amend/replace the legacy backend admin auth route + its tests
...
- [ ] T010 [test] Password-policy validator unit tests
...
- [ ] T011 Implement the shared password-policy validator
      ...
      Done when: T010 passes; module is the single source for D1–D4.
      Refs: D1–D7, FR-019, research R10

- [ ] T012 [test] Audit-log writer unit tests
...
- [ ] T013 Implement the audit-log writer
...
- [ ] T014 [test] LoginCode (OTP) service unit tests
...
- [ ] T015 Implement the LoginCode (OTP) service
      ...
      Done when: T014 passes; 100% branch coverage on the module.
      Refs: B1–B9, data-model.md §2

- [ ] T016 [test] PasswordResetToken service unit tests
...
- [ ] T017 Implement the PasswordResetToken service
      ...
      Done when: T016 passes; 100% branch coverage.
      Refs: C1–C6, data-model.md §3

- [ ] T018 [test] UserPreference service unit tests
...
- [ ] T019 Implement the UserPreference service
      ...
      Done when: T018 passes.
      Refs: H1/H2, FR-024

- [ ] T020 [test] requirePermission middleware unit tests
...
- [ ] T021 Implement the requirePermission middleware
      ...
      Done when: T020 passes; 100% branch coverage.
      Refs: FR-036, research R5

- [ ] T022 [test] AuthService core unit tests
...
- [ ] T023 Rewrite the AuthService
      ...
      Done when: T022 passes; 100% branch coverage on the security paths.
      Refs: A1–A6, B7, E1–E7, FR-036, research R3/R4/R6

### Backend routes (each contract endpoint is its own task)

- [ ] T024 [test] POST /admin/auth/login route test
...
- [ ] T025 Implement POST /admin/auth/login
...
- [ ] T026 [test] POST /admin/auth/verify-2fa route test
...
- [ ] T027 Implement POST /admin/auth/verify-2fa
      Files: `apps/api/src/routes/admin/auth.ts`
      Do: Verify OTP by `challengeId`, mint access token + refresh cookie on success.
      Done when: T026 passes.
      Refs: T-B1, contracts `verify-2fa`

- [ ] T028 [test] POST /admin/auth/resend-code route test
...
- [ ] T029 Implement POST /admin/auth/resend-code
      Files: `apps/api/src/routes/admin/auth.ts`
...
- [ ] T030 [test] POST /admin/auth/forgot-password route test
...
- [ ] T031 Implement POST /admin/auth/forgot-password
      Files: `apps/api/src/routes/admin/auth.ts`
...
- [ ] T032 [test] POST /admin/auth/reset-password route test
...
- [ ] T033 Implement POST /admin/auth/reset-password
      Files: `apps/api/src/routes/admin/auth.ts`
...
- [ ] T034 [test] POST /admin/auth/refresh route test
...
- [ ] T035 Implement POST /admin/auth/refresh
      Files: `apps/api/src/routes/admin/auth.ts`
...
- [ ] T036 [test] POST /admin/auth/logout route test
...
- [ ] T039 Implement GET /admin/auth/me
      Files: `apps/api/src/routes/admin/auth.ts`
...
- [ ] T040 [test] PUT /admin/settings/password route test
...
- [ ] T041 Implement PUT /admin/settings/password
...
- [ ] T042 [test] PUT /admin/settings/photo route test
...
- [ ] T043 Implement PUT /admin/settings/photo
      Files: `apps/api/src/routes/admin/settings.ts`
...
- [ ] T044 [test] GET /admin/settings/photo route test
...
- [ ] T045 Implement GET /admin/settings/photo
      Files: `apps/api/src/routes/admin/settings.ts`
      Do: Stream stored bytes for the authenticated user; `404` when absent.
      Done when: T044 passes.
      Refs: T-B4, G5/G6

- [ ] T046 [test] DELETE /admin/settings/photo route test
...
- [ ] T047 Implement DELETE /admin/settings/photo
      Files: `apps/api/src/routes/admin/settings.ts`
      Do: Null out bytes+MIME; block `super_admin`.
      Done when: T046 passes.
      Refs: G4

- [ ] T048 [test] GET /admin/settings/preferences route test
...
- [ ] T049 Implement GET /admin/settings/preferences
      Files: `apps/api/src/routes/admin/settings.ts`
      Do: Return persisted `themeMode`/`sidebarCollapsed`.
      Done when: T048 passes.
      Refs: T-B7, H1/H2

- [ ] T050 [test] PUT /admin/settings/preferences route test
...
- [ ] T051 Implement PUT /admin/settings/preferences
      Files: `apps/api/src/routes/admin/settings.ts`
      Do: Validate + upsert preferences via `userPreference` service.
      Done when: T050 passes.
      Refs: T-B7, FR-024

- [ ] T052 Document the Phase 1 endpoints in OpenAPI
...
- [ ] T054 Implement the `cn()` helper
      Files: `apps/web/src/admin/lib/cn.ts`
      Do: `clsx` + `tailwind-merge` wrapper used by all primitives.
      Done when: T053 passes.
      Refs: research R2

- [ ] T055 [test] Primitive parity contract test
...
- [ ] T061 Implement Avatar primitive with initials fallback
      Files: `apps/web/src/admin/ui/avatar.tsx`
      Do: Radix Avatar; render initials when no photo (G4).
      Done when: relevant T055 assertions pass.
      Refs: research R2, G4

- [ ] T062 Implement Sidebar primitive
...
- [ ] T068 Implement ThemeProvider + pre-paint boot script
      ...
      Done when: T067 passes; no FOUC.
      Refs: T-F2, H1/H2, research R8

### Frontend shell + pages + auth client

- [ ] T069 [test] Admin shell test (T-F1)
...
- [ ] T070 Implement ComingSoon content region
      Files: `apps/web/src/admin/shell/ComingSoon.tsx`
      Do: Centered, faded "Coming Soon" placeholder; no feature pages.
      Done when: relevant T069 assertions pass.
      Refs: T-F1, FR-021, H7

- [ ] T071 Implement Sidebar user section
...
- [ ] T078 Implement the ForgotPassword page
...
- [ ] T079 Implement the ResetPassword page
...
- [ ] T080 [test] Auth client + route guard test (T-F4)
...
- [ ] T081 Implement the admin apiClient hooks
      ...
      Done when: relevant T080 assertions pass.
      Refs: T-F4, E2/E3, FR-040

- [ ] T082 Implement the AuthProvider
...
- [ ] T085 Implement the Settings page
      ...
      Done when: T084 passes.
      Refs: T-F6, G6, FR-032/FR-033/FR-034/FR-035

- [ ] T086 Wire admin routing into the SPA
...
- [ ] T087 [test] Theme + sidebar persistence test (T-F2)
...
- [ ] T088 [test] Keyboard operability test (T-F3)
...
- [ ] T089 [test] Mobile off-canvas drawer test (T-F5)
...
- [ ] T090 [test] Audit events integration test (T-B6)
...
- [ ] T091 [test] E-CREDS — generic-credential + deactivated tests
...
- [ ] T092 Harden generic-credential + deactivated handling
      ...
      Done when: T091 passes.
      Refs: E-CREDS, A5/A6

- [ ] T093 [test] E-LOCK — lockout boundary tests
...
- [ ] T094 Harden account lockout + reset-clears-lock
      Files: `apps/api/src/services/auth.ts`
      Do: Enforce `failedLoginAttempts>=5` → `lockedUntil=now+15m`; reset clears counters.
      Done when: T093 passes; 100% branch on lockout paths.
      Refs: E-LOCK, A2/A3/A4/C5

- [ ] T095 [test] E-OTP — OTP edge tests
...
- [ ] T096 Harden OTP invalidation + challenge resolution
      ...
      Done when: T095 passes; 100% branch coverage.
      Refs: E-OTP, B3–B6/B9

- [ ] T097 [test] E-RESET — reset edge tests
...
- [ ] T098 Harden reset neutrality + account-wide revoke
      ...
      Done when: T097 passes; 100% branch coverage.
      Refs: E-RESET, C2/C3/C4/C6

- [ ] T099 [test] E-POLICY — password policy edge tests
...
- [ ] T100 Harden server-side policy enforcement on both paths
...
- [ ] T101 [test] E-THROTTLE — cooldown + window-cap tests
...
- [ ] T102 Harden resend cooldown + rolling-window cap
...
- [ ] T103 Wire the resend countdown into the UI
...
- [ ] T104 [test] E-PHOTO — photo validation edge tests
...
- [ ] T105 Harden profile-photo type/size validation
      Files: `apps/api/src/routes/admin/settings.ts`
...
- [ ] T106 [test] E-SESSION — session/refresh edge tests
...
- [ ] T107 Harden refresh rotation + protected-view redirect
      ...
      Done when: T106 passes; 100% branch on rotation paths.
      Refs: E-SESSION, E4/E5

- [ ] T108 [test] E-IDLE — idle-timeout test
...
- [ ] T109 Harden the 30m idle timeout via lastUsedAt
      Files: `apps/api/src/services/auth.ts`
...
- [ ] T110 [test] E-MAILFAIL — mailer-failure test
...
- [ ] T111 Harden mailer-failure handling (no orphaned consume)
      ...
      retryable error.
      Done when: T110 passes.
      Refs: E-MAILFAIL, SC-002

- [ ] T112 [test] E-SUPERADMIN — super_admin read-only test
...
- [ ] T113 Harden super_admin read-only enforcement
...
- [ ] T114 [test] E-A11Y/THEME — accessibility + theme-flash test
...
- [ ] T115 Harden contrast, focus, and pre-paint theme
...
- [ ] T122 Run a WCAG 2.1 AA audit on every Phase 1 surface
...
- [ ] T123 Run the real-OTP delivery check
...
- [ ] T124 Author the mobile design document
...
- [ ] T125 Cross-check FR → test traceability
...
- **Endpoints (one task each):** login (T024/25), verify-2fa (T026/27), resend-code (T028/29),
  forgot-password (T030/31), reset-password (T032/33), refresh (T034/35), logout (T036/37),
  me (T038/39), settings/password (T040/41), settings/photo PUT (T042/43) / GET (T044/45) /
  DELETE (T046/47), settings/preferences GET (T048/49) / PUT (T050/51).
- **Explicit asks:** `challengeId` stable-across-resend (T028/29, T095/96, B9); idle timeout via
  `lastUsedAt` (T108/109, E7); `GET settings/photo` bytes + `hasProfilePhoto` (T044/45, T038/39, G6);
  preferences read-back via `me` / `GET preferences` for cross-device load (T038/39, T048/49, H1/H2);
  `super_admin` 403 on settings (T112/113, FR-035); audit of settings password change (T041, T090, I1).
- **§4 test IDs covered:** T-B1 (T024/26), T-B2 (T030/32), T-B3 (T040), T-B4 (T042/44), T-B5 (T038),
  T-B6 (T090), T-B7 (T048/50); T-F1 (T069), T-F2 (T067/087), T-F3 (T088), T-F4 (T080), T-F5 (T089),
  T-F6 (T075/084); E-OTP, E-LOCK, E-CREDS, E-RESET, E-POLICY, E-THROTTLE, E-PHOTO, E-SESSION,
  E-A11Y/THEME, E-SUPERADMIN, E-IDLE, E-MAILFAIL (T091–T115).
- **§2 assertions enforced:** A1–A6 (T022/23, T091–94); B1–B9 (T014/15, T095/96); C1–C6 (T016/17,
  T097/98); D1–D7 (T010/11, T099/100); E1–E7 (T022/23, T106–109); F1–F4 (T101–103); G1–G6 (T042–47,
  T104/105); H1–H7 (T003, T067/68, T069–73, T087–89, T114/115); I1–I3 (T012/13, T090).
