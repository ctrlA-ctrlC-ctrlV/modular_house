...
interface SubmissionResponse {
  ok: boolean;
  id: string;
  /** Quote number generated by the backend (e.g. "Q2610005"). */
  quoteNumber: string;
}
...
class ApiClient {
   ...
   *
   * Accepts the standard contact form fields plus optional configurator-
   * specific fields. When the submission originates from the garden room
   * configurator, the caller includes sourcePage, product slug, finish
   * names, add-on list, total price, and preferred date. Non-configurator
   * callers omit these fields, preserving backward compatibility.
   */
