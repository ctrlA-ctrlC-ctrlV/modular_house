    ...
    <div className="l-container py-16">
      ...
      <div id='garden_room_gallery'>
        <FullMassonryGallery
          itemCount = {5}
          items = {[
            { imageUrl: '/resource/garden-room/garden-room1.png', title: 'Modular House Garden Room 1', category: 'Garden Room' },
            { imageUrl: '/resource/garden-room/garden-room4.png', title: 'Modular House Garden Room 2', category: 'Garden Room' },
            { imageUrl: '/resource/garden-room/garden-room2.png', title: 'Modular House Garden Room 3', category: 'Garden Room' },
            { imageUrl: '/resource/garden-room/garden-room3.png', title: 'Modular House Garden Room 4', category: 'Garden Room' },
            { imageUrl: '/resource/garden-room/garden-room5.png', title: 'Modular House Garden Room 5', category: 'Garden Room' },
          ]}
