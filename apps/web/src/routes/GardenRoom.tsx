    ...
    <div className="l-container py-16">
      ...
      <div id="product-range">
        <ProductRangeGrid
          ...
          description={<>We design, manufacture every garden room in-house from our Dublin factory. Built for home offices, studios, gyms, guest suites, and more.<br /><br />We offer free site visit for the greater Dublin Area.</>}
          headerContent={
            <InfoButton
