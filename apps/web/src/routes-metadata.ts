          ...
          data: {
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Yes. We provide a comprehensive 60-year structural warranty on our steel frames. Because steel is inorganic and durable, you can be confident your investment is protected against the elements for decades.',
                },
              },
            ],
          },
      ...
      schema: [
        ...
        // ------------------------------------------------------------------
        {
          ...
          data: {
            ...
            description: 'Premium steel frame house extensions in Dublin. Fixed-price contracts, A-rated insulation, and 60-year structural warranty.',
            // IMAGE PROPERTY (REQUIRED)
            // Google Search Console requires an image for Product rich results.
            // This URL matches the Open Graph image used for social sharing.
            image: 'https://modularhouse.ie/resource/house-extension/hosue-extension1.png',
        ...
        ...generatePageSchema(
          ...
          'Looking for a house extension in Dublin? Modular House builds premium steel frame house extensions with fixed-price contracts, A-rated insulation, and a 60-year structural warranty.',
          BUILD_TIMESTAMP
        ),
      ],
    },
