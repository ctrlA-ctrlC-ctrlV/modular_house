// Sheet primitive — Radix Dialog-based off-canvas drawer for mobile sidebar (H5) and overlays.
...
// Drawer panel with side variants, 18rem max on sm (H3), and inline close button.
