...
- **Pre-existing drift**: migration `20260625102529_modular_panel_1` was auto-generated by
  `prisma migrate dev` during Phase 1 setup to make `users.role_id` `NOT NULL`, closing a
  feature-006 drift left by `20260224155034_admin_panel_redesign_models`. It is not part of the
  Phase 1 data model but is required for `prisma migrate dev` to report "already in sync".
