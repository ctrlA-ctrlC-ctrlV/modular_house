...
- [ ] T001 Create monorepo scaffolding in repository root: `pnpm-workspace.yaml`, `package.json`, `.editorconfig`, `.gitignore`, `.env.example`
...
- [ ] T006 Add local dev services in `infra/docker-compose.yml` (Postgres 15+/18, MailHog) and `infra/scripts/`
